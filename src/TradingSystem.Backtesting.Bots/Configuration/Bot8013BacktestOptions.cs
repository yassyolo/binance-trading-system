...
public sealed record Bot8013BacktestOptions : ITpOnlyGridBacktestOptions
{
    public string BotName{ get; init; } = "BOT8013";
    ...
    public decimal EntryFeeRate{ get; init; } = .0004m;
    
    public decimal ExitFeeRate{ get; init; } = .0004m;
