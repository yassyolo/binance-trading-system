...
/// <summary>
/// Internal protected-position entry candidate for BOT8015.
/// Requires Alligator alignment and close on the same side of SMA200.
/// STOP3/trailing behavior remains in BOT8015's existing lifecycle.
/// </summary>
public sealed class Bot8015SignalGenerator(IOptions<Bot8015Options> options) : ITradingSignalGenerator
{
    ...
    public ValueTask<GeneratedTradingSignal?> GenerateAsync(MarketIndicatorSnapshot x, CancellationToken ct)
    {
        ...
        return ValueTask.FromResult<GeneratedTradingSignal?>(new(
            ...
            x.CandleOpenTimeUtc, x.Interval, x.Close, "Alligator alignment confirmed by SMA200 trend filter.",
