...
public static class DependencyInjection
{
    public static IServiceCollection AddBot8015(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<IBinanceTradingConfiguration>(
            serviceProvider => serviceProvider.GetRequiredService<IOptions<Bot8015Options>>().Value);
        ...
        services.AddSingleton<IBotOrderEventHandler, Bot8015PositionEvents>();
        services.AddSingleton<IBotHealingService, Bot8015HealingService>();
        services.AddSingleton<ITradingSignalGenerator, Bot8015SignalGenerator>();
