      ...
      IRiskAdmissionLifecycle
{
    ...
    public async Task<RiskDecision> EvaluateOpenAsync(RiskEvaluationContext context, CancellationToken ct)
    {
        ...
        try
        {
            ...
            var botPositions = snapshot.Positions.Count(x => x.BotName.Equals(context.Signal.BotName, StringComparison.OrdinalIgnoreCase));
            ...
            var symbolPositions = snapshot.Positions.Count(x => x.Symbol.Equals(context.Signal.Symbol, StringComparison.OrdinalIgnoreCase));
            ...
            var symbolReservations = activeReservations.Where(x => x.Symbol.Equals(context.Signal.Symbol, StringComparison.OrdinalIgnoreCase));
