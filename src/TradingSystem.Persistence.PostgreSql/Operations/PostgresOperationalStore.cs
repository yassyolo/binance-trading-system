...
public sealed class OperationalAlertCandidateSource(ITradingDbConnectionFactory factory):IAlertCandidateSource
{
 ...
 {
  await using var c = await factory.OpenAsync(ct);var result = new List<AlertCandidate>();
