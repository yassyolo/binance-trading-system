...
builder.Services.AddOptions<MarketDataOptions>().Bind(builder.Configuration.GetSection(MarketDataOptions.SectionName)).Validate(x =>  x.Symbols.Length>0 && x.Intervals.Length>0, "Symbols and intervals are required").ValidateOnStart();
