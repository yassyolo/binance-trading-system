...
public interface IBinanceFuturesOrderClient
{
    ...
    Task<BinanceOrderResult> GetOrderByClientOrderIdAsync(string symbol, string clientOrderId, CancellationToken ct);
    ...
    Task<IReadOnlyCollection<BinanceTradeFill>> GetTradeFillsForOrderAsync(string symbol, string orderId, CancellationToken ct);
}
