...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddOptions<BinanceRetryOptions>()
            .Bind(configuration.GetSection(BinanceRetryOptions.SectionName))
            .ValidateOnStart();
        ...
        services.AddHttpClient<IBinanceFuturesMarketClient, BinanceFuturesMarketClient>()
            .ConfigureHttpClient(ConfigureBinanceHttpClient);

        services.AddHttpClient<IBinanceFuturesOrderClient, BinanceFuturesOrderClient>()
            .ConfigureHttpClient(ConfigureBinanceHttpClient);
