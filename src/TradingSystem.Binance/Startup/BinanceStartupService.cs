	...
	: IHostedService
{
	...
	private async Task TrySetHedgeModeAsync(
		CancellationToken ct)
	{
		...
		catch (Exception exception)
		{
			logger.LogWarning(
				exception,
				"Could not set hedge mode. It may already be enabled or the account may reject the request.");
		}
	}
